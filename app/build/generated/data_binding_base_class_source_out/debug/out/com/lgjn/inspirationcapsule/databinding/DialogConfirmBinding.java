...
public final class DialogConfirmBinding implements ViewBinding {
  ...
  private DialogConfirmBinding(@NonNull LinearLayout rootView, @NonNull TextView dialogBtnCancel,
      @NonNull TextView dialogBtnConfirm, @NonNull TextView dialogMessage,
  ...
  public static DialogConfirmBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogConfirmBinding((LinearLayout) rootView, dialogBtnCancel, dialogBtnConfirm,
